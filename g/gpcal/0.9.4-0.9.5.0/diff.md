# Comparing `tmp/gpcal-0.9.4.tar.gz` & `tmp/gpcal-0.9.5.0.tar.gz`
...
## Comparing `gpcal-0.9.4.tar` & `gpcal-0.9.5.0.tar`
...
### Comparing `gpcal-0.9.4/PKG-INFO` & `gpcal-0.9.5.0/PKG-INFO`
...
### Comparing `gpcal-0.9.4/README.rst` & `gpcal-0.9.5.0/README.rst`
...
### Comparing `gpcal-0.9.4/gpcal/gpcal.py` & `gpcal-0.9.5.0/gpcal/gpcal.py`
...
### Comparing `gpcal-0.9.4/setup.py` & `gpcal-0.9.5.0/setup.py`
