# Comparing `tmp/otgCrypto-0.0.5.tar.gz` & `tmp/otgCrypto-0.0.6.tar.gz`
...
## Comparing `otgCrypto-0.0.5.tar` & `otgCrypto-0.0.6.tar`
...
### Comparing `otgCrypto-0.0.5/LICENSE.txt` & `otgCrypto-0.0.6/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `otgCrypto-0.0.5/PKG-INFO` & `otgCrypto-0.0.6/PKG-INFO`
...
### Comparing `otgCrypto-0.0.5/README.txt` & `otgCrypto-0.0.6/README.txt`
...
### Comparing `otgCrypto-0.0.5/otgCrypto.egg-info/PKG-INFO` & `otgCrypto-0.0.6/otgCrypto.egg-info/PKG-INFO`
...
### Comparing `otgCrypto-0.0.5/setup.py` & `otgCrypto-0.0.6/setup.py`
