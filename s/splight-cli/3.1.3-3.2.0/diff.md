# Comparing `tmp/splight-cli-3.1.3.tar.gz` & `tmp/splight-cli-3.2.0.tar.gz`
...
### Comparing `splight-cli-3.1.3/cli/component/templates/tests.py` & `splight-cli-3.2.0/cli/component/templates/tests.py`
