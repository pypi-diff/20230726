# Comparing `tmp/adafri-0.0.61.tar.gz` & `tmp/adafri-0.0.62.tar.gz`
...
### Comparing `adafri-0.0.61/adafri/v1/user/models/user_fields.py` & `adafri-0.0.62/adafri/v1/user/models/user_fields.py`
