# Comparing `tmp/durkinza.cdk-networkfirewall-l2-0.0.1.tar.gz` & `tmp/durkinza.cdk-networkfirewall-l2-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "durkinza.cdk-networkfirewall-l2-0.0.1.tar", last modified: Wed Jul 26 02:43:19 2023, max compression
...
## Comparing `durkinza.cdk-networkfirewall-l2-0.0.1.tar` & `durkinza.cdk-networkfirewall-l2-0.0.2.tar`

### file list

```diff
@@ -1,22 +1,22 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-26 02:43:19.243241 durkinza.cdk-networkfirewall-l2-0.0.1/
--rw-r--r--   0 runner    (1001) docker     (123)    11358 2023-07-26 02:42:59.000000 durkinza.cdk-networkfirewall-l2-0.0.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       23 2023-07-26 02:42:59.000000 durkinza.cdk-networkfirewall-l2-0.0.1/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     1246 2023-07-26 02:43:19.243241 durkinza.cdk-networkfirewall-l2-0.0.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      243 2023-07-26 02:42:59.000000 durkinza.cdk-networkfirewall-l2-0.0.1/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      234 2023-07-26 02:42:59.000000 durkinza.cdk-networkfirewall-l2-0.0.1/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-26 02:43:19.243241 durkinza.cdk-networkfirewall-l2-0.0.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1922 2023-07-26 02:42:59.000000 durkinza.cdk-networkfirewall-l2-0.0.1/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-26 02:43:19.239241 durkinza.cdk-networkfirewall-l2-0.0.1/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-26 02:43:19.239241 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-26 02:43:19.243241 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza/cdk_networkfirewall_l2/
--rw-r--r--   0 runner    (1001) docker     (123)   196258 2023-07-26 02:42:59.000000 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza/cdk_networkfirewall_l2/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-26 02:43:19.243241 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza/cdk_networkfirewall_l2/_jsii/
--rw-r--r--   0 runner    (1001) docker     (123)      434 2023-07-26 02:42:59.000000 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza/cdk_networkfirewall_l2/_jsii/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    91918 2023-07-26 02:42:59.000000 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza/cdk_networkfirewall_l2/_jsii/cdk-networkfirewall-l2@0.0.1.jsii.tgz
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-26 02:42:59.000000 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza/cdk_networkfirewall_l2/py.typed
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-26 02:43:19.243241 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza.cdk_networkfirewall_l2.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     1246 2023-07-26 02:43:19.000000 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza.cdk_networkfirewall_l2.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      574 2023-07-26 02:43:19.000000 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza.cdk_networkfirewall_l2.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-26 02:43:19.000000 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza.cdk_networkfirewall_l2.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)      111 2023-07-26 02:43:19.000000 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza.cdk_networkfirewall_l2.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        9 2023-07-26 02:43:19.000000 durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza.cdk_networkfirewall_l2.egg-info/top_level.txt
...
### Comparing `durkinza.cdk-networkfirewall-l2-0.0.1/LICENSE` & `durkinza.cdk-networkfirewall-l2-0.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `durkinza.cdk-networkfirewall-l2-0.0.1/setup.py` & `durkinza.cdk-networkfirewall-l2-0.0.2/setup.py`
...
@@ -22,15 +22,15 @@
     ...
     "package_data": {
         "durkinza.cdk_networkfirewall_l2._jsii": [
-            "cdk-networkfirewall-l2@0.0.1.jsii.tgz"
...
### Comparing `durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza/cdk_networkfirewall_l2/__init__.py` & `durkinza.cdk-networkfirewall-l2-0.0.2/src/durkinza/cdk_networkfirewall_l2/__init__.py`
...
### Comparing `durkinza.cdk-networkfirewall-l2-0.0.1/src/durkinza.cdk_networkfirewall_l2.egg-info/SOURCES.txt` & `durkinza.cdk-networkfirewall-l2-0.0.2/src/durkinza.cdk_networkfirewall_l2.egg-info/SOURCES.txt`
...
-src/durkinza/cdk_networkfirewall_l2/_jsii/cdk-networkfirewall-l2@0.0.1.jsii.tgz
