# Comparing `tmp/kappadata-1.3.7.tar.gz` & `tmp/kappadata-1.3.8.tar.gz`
...
### Comparing `kappadata-1.3.7/README.md` & `kappadata-1.3.8/README.md`
...
### Comparing `kappadata-1.3.7/kappadata/collators/kd_dino_mask_collator.py` & `kappadata-1.3.8/kappadata/collators/kd_dino_mask_collator.py`
...
### Comparing `kappadata-1.3.7/kappadata/utils/save_image.py` & `kappadata-1.3.8/kappadata/utils/save_image.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/utils/transform_utils.py` & `kappadata-1.3.8/kappadata/utils/transform_utils.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/visualization/visualize_dataset_imgsize.py` & `kappadata-1.3.8/kappadata/visualization/visualize_dataset_imgsize.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/visualization/visualize_interpolation.py` & `kappadata-1.3.8/kappadata/visualization/visualize_interpolation.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/visualization/visualize_jigsaw.py` & `kappadata-1.3.8/kappadata/visualization/visualize_jigsaw.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/visualization/visualize_mae_schematic.py` & `kappadata-1.3.8/kappadata/visualization/visualize_mae_schematic.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/visualization/visualize_masked_image.py` & `kappadata-1.3.8/kappadata/visualization/visualize_masked_image.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/visualization/visualize_transform.py` & `kappadata-1.3.8/kappadata/visualization/visualize_transform.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/visualization/visualize_two_random_crop.py` & `kappadata-1.3.8/kappadata/visualization/visualize_two_random_crop.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/dataset_wrappers/class_filter_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/dataset_wrappers/class_filter_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/dataset_wrappers/classwise_subset_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/dataset_wrappers/classwise_subset_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/dataset_wrappers/oversampling_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/dataset_wrappers/oversampling_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/dataset_wrappers/overwrite_classes_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/dataset_wrappers/overwrite_classes_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/dataset_wrappers/percent_filter_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/dataset_wrappers/percent_filter_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/dataset_wrappers/repeat_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/dataset_wrappers/repeat_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/dataset_wrappers/subset_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/dataset_wrappers/subset_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/mode_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/mode_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/sample_wrappers/base/transform_wrapper_base.py` & `kappadata-1.3.8/kappadata/wrappers/sample_wrappers/base/transform_wrapper_base.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/sample_wrappers/kd_multi_view_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/sample_wrappers/kd_multi_view_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/sample_wrappers/label_smoothing_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/sample_wrappers/label_smoothing_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/sample_wrappers/semseg_transform_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/sample_wrappers/semseg_transform_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata/wrappers/torch_wrapper.py` & `kappadata-1.3.8/kappadata/wrappers/torch_wrapper.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/kappadata.egg-info/PKG-INFO` & `kappadata-1.3.8/kappadata.egg-info/PKG-INFO`
...
### Comparing `kappadata-1.3.7/kappadata.egg-info/SOURCES.txt` & `kappadata-1.3.8/kappadata.egg-info/SOURCES.txt`
...
+kappadata/collators/kd_ijepa_mask_collator.py
...
+tests_external_sources/dinov2.py
+tests_external_sources/ijepa.py
```

### Comparing `kappadata-1.3.7/setup.cfg` & `kappadata-1.3.8/setup.cfg`
...
### Comparing `kappadata-1.3.7/test_unit_long/test_stochastic_transform_seed.py` & `kappadata-1.3.8/test_unit_long/test_stochastic_transform_seed.py`

 * *Files identical despite different names*

### Comparing `kappadata-1.3.7/tests_external_sources/dinov2.py` & `kappadata-1.3.8/tests_external_sources/dinov2.py`
