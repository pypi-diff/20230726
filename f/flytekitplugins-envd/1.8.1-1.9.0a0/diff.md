...
```diff
@@ -1 +1 @@
-gzip compressed data, was "flytekitplugins-envd-1.8.1.tar", last modified: Tue Jul 18 18:01:37 2023, max compression
+gzip compressed data, was "flytekitplugins-envd-1.9.0a0.tar", last modified: Thu Jul 20 18:58:18 2023, max compression
```

## Comparing `flytekitplugins-envd-1.8.1.tar` & `flytekitplugins-envd-1.9.0a0.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 18:01:37.459021 flytekitplugins-envd-1.8.1/
--rw-r--r--   0 runner    (1001) docker     (123)      886 2023-07-18 18:01:37.459021 flytekitplugins-envd-1.8.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      797 2023-07-18 18:01:17.000000 flytekitplugins-envd-1.8.1/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 18:01:37.455021 flytekitplugins-envd-1.8.1/flytekitplugins/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 18:01:37.459021 flytekitplugins-envd-1.8.1/flytekitplugins/envd/
--rw-r--r--   0 runner    (1001) docker     (123)      255 2023-07-18 18:01:17.000000 flytekitplugins-envd-1.8.1/flytekitplugins/envd/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     3905 2023-07-18 18:01:17.000000 flytekitplugins-envd-1.8.1/flytekitplugins/envd/image_builder.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-18 18:01:37.459021 flytekitplugins-envd-1.8.1/flytekitplugins_envd.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      886 2023-07-18 18:01:37.000000 flytekitplugins-envd-1.8.1/flytekitplugins_envd.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      408 2023-07-18 18:01:37.000000 flytekitplugins-envd-1.8.1/flytekitplugins_envd.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-18 18:01:37.000000 flytekitplugins-envd-1.8.1/flytekitplugins_envd.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       47 2023-07-18 18:01:37.000000 flytekitplugins-envd-1.8.1/flytekitplugins_envd.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-07-18 18:01:37.000000 flytekitplugins-envd-1.8.1/flytekitplugins_envd.egg-info/namespace_packages.txt
--rw-r--r--   0 runner    (1001) docker     (123)       22 2023-07-18 18:01:37.000000 flytekitplugins-envd-1.8.1/flytekitplugins_envd.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       16 2023-07-18 18:01:37.000000 flytekitplugins-envd-1.8.1/flytekitplugins_envd.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-18 18:01:37.459021 flytekitplugins-envd-1.8.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1320 2023-07-18 18:01:33.000000 flytekitplugins-envd-1.8.1/setup.py
...
### Comparing `flytekitplugins-envd-1.8.1/PKG-INFO` & `flytekitplugins-envd-1.9.0a0/PKG-INFO`
...
### Comparing `flytekitplugins-envd-1.8.1/README.md` & `flytekitplugins-envd-1.9.0a0/README.md`

 * *Files identical despite different names*

### Comparing `flytekitplugins-envd-1.8.1/flytekitplugins/envd/image_builder.py` & `flytekitplugins-envd-1.9.0a0/flytekitplugins/envd/image_builder.py`
...
### Comparing `flytekitplugins-envd-1.8.1/flytekitplugins_envd.egg-info/PKG-INFO` & `flytekitplugins-envd-1.9.0a0/flytekitplugins_envd.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-envd-1.8.1/setup.py` & `flytekitplugins-envd-1.9.0a0/setup.py`
