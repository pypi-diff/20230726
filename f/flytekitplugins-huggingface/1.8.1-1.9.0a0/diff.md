...
## Comparing `flytekitplugins-huggingface-1.8.1.tar` & `flytekitplugins-huggingface-1.9.0a0.tar`
...
### Comparing `flytekitplugins-huggingface-1.8.1/PKG-INFO` & `flytekitplugins-huggingface-1.9.0a0/PKG-INFO`
...
### Comparing `flytekitplugins-huggingface-1.8.1/README.md` & `flytekitplugins-huggingface-1.9.0a0/README.md`

 * *Files identical despite different names*

### Comparing `flytekitplugins-huggingface-1.8.1/flytekitplugins/huggingface/sd_transformers.py` & `flytekitplugins-huggingface-1.9.0a0/flytekitplugins/huggingface/sd_transformers.py`
...
### Comparing `flytekitplugins-huggingface-1.8.1/flytekitplugins_huggingface.egg-info/PKG-INFO` & `flytekitplugins-huggingface-1.9.0a0/flytekitplugins_huggingface.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins-huggingface-1.8.1/setup.py` & `flytekitplugins-huggingface-1.9.0a0/setup.py`
