...
-generation ESO instrument MAVIS. If you use MAVISIM please cite Monty_et_al.
-2021. ## Current Version **1.1 - EtE PSF** - more accurate representation of
-the PSF, suitable for photometric and astrometric science cases Documentation
-can be found here ## Past Versions 1.0 - Fourier PSF - fast, most flexibility
-for astrometric modeling Documentation can be found here ## General Features 1.
...
+MAVISIM please cite Monty_et_al._2021. ## Current Version **1.1 - EtE PSF** -
+more accurate representation of the PSF, suitable for photometric and
+astrometric science cases Documentation can be found here ## Past Versions 1.0
+- Fourier PSF - fast, most flexibility for astrometric modeling Documentation
+can be found here ## General Features 1. Can simulate full stellar field (eg.
